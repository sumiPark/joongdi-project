...
- hook: 4-5문장, 독자를 끌어당기는 도입
- analysis: 7-10문장, 흐름 있게 상세히
- pros: 3-4가지, 각 3-4문장으로 구체적 근거 포함
- cons: 2가지, 각 2-3문장
- target: 4-5문장
- conclusion: 4-5문장
전체 본문 합산 1500-2000자 목표`,
  },
  long: {
    tokens: 3500,
...
**[인간 작성 느낌 필수 준수 — 가장 중요]**

이 글은 AI가 쓴 게 아니라 실제 사람이 직접 경험하고 쓴 블로그 글이어야 합니다.

▶ 반드시 피해야 할 AI 특유의 패턴:
- "또한", "더불어", "이처럼", "따라서", "결론적으로" 같은 문어체 접속사로 문단 시작 금지
- 모든 장점을 같은 길이, 같은 형식으로 나열하는 완벽한 병렬 구조 금지
- "~것이 중요합니다", "~필요가 있습니다", "~할 수 있습니다" 반복 금지
- 매 문단을 깔끔하게 요약하며 끝내는 패턴 금지
- 근거 없이 균형 잡힌 척하는 "장점도 있지만 단점도 있어요" 식의 중립적 서술 금지

▶ 사람이 쓴 것처럼 보이게 하는 요소:
- 문장 길이를 의도적으로 다양하게: 짧은 한 문장. 그 다음엔 좀 더 길게 이유를 풀어서 설명하는 문장이 자연스럽게 이어지는 식으로
- 구어체 표현 자연스럽게: "근데", "솔직히", "뭐", "그냥", "진짜로", "아" 등
- 개인적 관찰이나 의외의 디테일 포함: (처음엔 이게 뭔가 했는데), (이 부분에서 좀 놀랐어요)
- 흠결도 진짜처럼: 아쉬운 점은 쓴 사람도 실제로 느낀 것처럼, 변명하지 않고 담담하게
- 완벽하게 정제되지 않은 자연스러운 흐름: 모든 문장이 새 정보를 전달할 필요 없음
